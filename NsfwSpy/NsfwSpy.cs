...
public class NsfwSpy : INsfwSpy
{
    ...
    /// <returns>
    ///     A NsfwSpyResult that indicates the predicted value and scores for the 5 categories of
    ///     classification.
    /// </returns>
    ...
    public List<NsfwSpyValue> ClassifyImages(
        IEnumerable<string> filesPaths,
        Action<string, NsfwSpyResult> actionAfterEachClassify = null)
    {
    ...
    /// <param name="videoOptions">VideoOptions to customise how the frames of the file are classified.</param>
    /// <returns>A NsfwSpyFramesResult with results for each frame classified.</returns>
    public NsfwSpyFramesResult ClassifyGif(
        Uri uri,
    ...
    /// <param name="videoOptions">VideoOptions to customise how the frames of the file are classified.</param>
    /// <returns>A NsfwSpyFramesResult with results for each frame classified.</returns>
    public async Task<NsfwSpyFramesResult> ClassifyGifAsync(
        Uri uri,
        WebClient webClient = null,
        VideoOptions videoOptions = null)
    {
    ...
    /// <param name="videoOptions">VideoOptions to customise how the frames of the file are classified.</param>
    /// <returns>A NsfwSpyFramesResult with results for each frame classified.</returns>
    public NsfwSpyFramesResult ClassifyVideo(
        Uri uri,
        WebClient webClient = null,
        VideoOptions videoOptions = null)
    {
    ...
    /// <param name="videoOptions">VideoOptions to customise how the frames of the file are classified.</param>
    /// <returns>A NsfwSpyFramesResult with results for each frame classified.</returns>
    public async Task<NsfwSpyFramesResult> ClassifyVideoAsync(
        string filePath,
        VideoOptions videoOptions = null)
    {
